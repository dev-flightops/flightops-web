...
function LoginInner({ providers }: { providers: ProviderSummary[] }) {
  ...
  const ssoError = searchParams.get("error"); // Auth.js sets this on OAuth failure
  ...
  return (
    <Card className="w-[400px]">
      <CardHeader className="space-y-3">
        ...
        <CardDescription>
          Enter your FlightOps email and password to continue.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      placeholder="admin@flightops.local"
                      autoComplete="email"
                      {...field}
                    />
                  </FormControl>
        ...
        <SsoButtons providers={providers} callbackUrl={from} />
      </CardContent>
    </Card>
  );
}
