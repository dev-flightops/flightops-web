...
/**
 * /flight-log — Electronic Flight Log landing (M2-G-26b rebuild).
 *
 ...
 *     Flight Type, submit creates a draft + redirects to the stub
 *     per-log detail page (M3 builds the rich 7-tab editor)
 *
 * The dispatcher's historical "completed flights with real ATD/ATA"
 * view that lived here before M2-G-26b moved into
 * `/flight-following/history` so it doesn't disappear — same data,
 * better-named home.
 *
