...
export interface HomeModule {
  ...
  iconPath: string;
  /** When set, the tile only renders for users whose `session.roles`
   * includes this string. Used for external / role-scoped surfaces
   * like the supplier portal — invisible to everyone else. */
  roleGate?: string;
}
